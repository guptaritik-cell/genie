...
function ChatTopBar({ balance, onBack, onOpenHistory }: { balance: number; onBack?: () => void; onOpenHistory?: () => void }) {
  const chipBalance = balance >= 1000 ? `${(balance / 1000).toFixed(1)}k` : String(balance);
  return (
      ...
      <div className="flex gap-[8px] h-[48px] items-center px-[12px] relative shrink-0 w-full">
        ...
        <div className="flex gap-[8px] items-center shrink-0">
          ...
          <button
            ...
            style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "40px", height: "40px", background: "none", border: "none", cursor: "pointer", flexShrink: 0 }}
            aria-label="Recent chats"
          >
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M22 22C22.5523 22 23 22.4477 23 23C23 23.5523 22.5523 24 22 24H11C10.4477 24 10 23.5523 10 23C10 22.4477 10.4477 22 11 22H22ZM29 16C29.5523 16 30 16.4477 30 17C30 17.5523 29.5523 18 29 18H11C10.4477 18 10 17.5523 10 17C10 16.4477 10.4477 16 11 16H29Z" fill="#E6E6E6"/>
            </svg>
          </button>
          {/* POPcoin badge */}
          <div
          ...
          >
            <img decoding="async" alt="" style={{ width: 16, height: 16, flexShrink: 0 }} src={popCoinIcon} />
    ...
    <div className="absolute left-1/2" style={{ bottom: "24px", transform: "translateX(-50%)", width: "369px", maxWidth: "calc(100% - 24px)" }}>
      ...
      <div
        style={{
          ...
          width: "369px", height: "104px", pointerEvents: "none",
          background: "radial-gradient(105.65% 187.5% at 50% -21.43%, rgba(255,152,88,0.25) 3.86%, rgba(255,82,0,0.15) 28.43%, rgba(205,52,1,0.05) 55.29%, transparent 100%)",
          filter: "blur(22px)",
        }}
      />
  ...
  return (
    <div className="bg-[#0d0d0d] relative overflow-hidden" style={{ height: "100%", width: "100%" }}>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(65% 42% at 50% 63%, rgba(255,64,20,0.32) 0%, rgba(180,20,0,0.18) 45%, transparent 78%)",
          mixBlendMode: "screen",
          opacity: mounted ? 1 : 0.15,
          transition: "opacity 1253ms cubic-bezier(0.42,0,0.48,1) 0ms",
        }}
      />
